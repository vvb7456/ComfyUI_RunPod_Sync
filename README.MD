...
| `PLUGIN_URLS` | 否 | 自定义插件 Git 地址列表，逗号分隔。如不填则使用脚本内置的默认推荐列表。 |
...
脚本运行后，`/workspace/ComfyUI/models` 将呈现如下结构（由 Sorter 自动整理）：
